...
public class RetornoConsultaProcedimento  implements java.io.Serializable {
     ...
     */
    public void setUnidadesProcedimentoAberto(UnidadeProcedimentoAberto[] unidadesProcedimentoAberto) {
        this.unidadesProcedimentoAberto = unidadesProcedimentoAberto;
    }
     ...
     */
    public void setProcedimentosRelacionados(ProcedimentoResumido[] procedimentosRelacionados) {
        this.procedimentosRelacionados = procedimentosRelacionados;
    }
     ...
     */
    public void setProcedimentosAnexados(ProcedimentoResumido[] procedimentosAnexados) {
        this.procedimentosAnexados = procedimentosAnexados;
    }
